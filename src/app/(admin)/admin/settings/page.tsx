    ...
    <div className="space-y-8 max-w-3xl">
      ...
      <section className="border border-onyx/10 bg-white p-6 md:p-8 space-y-4">
        ...
        <dl className="grid grid-cols-[120px_1fr] gap-y-3 text-sm">
          <dt className="text-stone">Email</dt><dd className="break-all">{session?.email}</dd>
      ...
      <section className="border border-onyx/10 bg-white p-6 md:p-8 space-y-4">
        ...
        <p className="text-xs text-stone">
          These values are stored in <code>src/content/site.ts</code> and deploy with the codebase. To change them, update the file and push to main.
        </p>
      </section>
      ...
      <section className="border border-onyx/10 bg-white p-6 md:p-8 space-y-3">
        ...
        <p className="text-sm text-stone leading-relaxed">
          Five studio forms are live on the public site: Contact, Request-a-Quote, Careers, Trainee Applications and Newsletter. Submissions route into the Inbox automatically.
        </p>
